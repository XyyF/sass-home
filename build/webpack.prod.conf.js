...
const getEntryConfig = (entryInfo) => {
    const webpackConfig = {
        entry: {
            [entryInfo.entryName]: path.join(path.dirname(entryInfo.indexPath), 'index.js'), // 获得入口js文件
        },
        module: {
        ...
        output: {
            publicPath: nocdn ? config.build.assetsPublicPath : `//${env.QN_PATH}/`, //资源路径,根据需要可改为cdn地址
